...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CartEntities> product, num subTotal});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<CartEntities> product, this.subTotal)
      : _product = product;

  final List<CartEntities> _product;
  @override
  List<CartEntities> get product {
  ...
  @override
  String toString() {
    return 'CartState.loaded(product: $product, subTotal: $subTotal)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_product), subTotal);
...
abstract class _Loaded implements CartState {
  const factory _Loaded(final List<CartEntities> product, final num subTotal) =
      _$LoadedImpl;
...
/// @nodoc
abstract class _$$UnautorizeImplCopyWith<$Res> {
  factory _$$UnautorizeImplCopyWith(
          _$UnautorizeImpl value, $Res Function(_$UnautorizeImpl) then) =
      __$$UnautorizeImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$UnautorizeImplCopyWithImpl<$Res>
    extends _$CartStateCopyWithImpl<$Res, _$UnautorizeImpl>
    implements _$$UnautorizeImplCopyWith<$Res> {
  __$$UnautorizeImplCopyWithImpl(
      _$UnautorizeImpl _value, $Res Function(_$UnautorizeImpl) _then)
      : super(_value, _then);
...
class _$UnautorizeImpl implements _Unautorize {
  const _$UnautorizeImpl();

  @override
  String toString() {
    return 'CartState.unautorize()';
  }
...
abstract class _Unautorize implements CartState {
  const factory _Unautorize() = _$UnautorizeImpl;
}
