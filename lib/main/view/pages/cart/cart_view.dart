...
import 'package:woodman_project_fe/main/view/pages/cart/cubit/cart_cubit.dart';
...
class CartView extends StatelessWidget {
  ...
  Widget _loaded(BuildContext context, List<ProductModel> products,
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _cartCard(context, product, quantity);
            },
          ),
        ),
  ...
  Widget _cartCard(BuildContext context, ProductModel product, int quantity) {
    return Container(
